@extends('layouts.app', ['heading' => 'Auto Schedule Seminar'])

@section('content')
<form method="post" action="{{ route('admin.seminars.auto.preview') }}" class="card shadow-sm border-0">
    @csrf
    <div class="card-body row g-3">
        ...
        <div class="col-12">
            <div class="form-check mt-2">
                ...
                <label class="form-check-label" for="regenerateCheck">Regenerate Jadwal (hapus jadwal DRAFT lama di periode)</label>
            </div>
        </div>
    </div>
